      ...
      <Button
        ...
        className={
          editor.isActive("bold")
            ? "is-active p-1 border rounded bg-black text-white"
            : "p-1 border rounded"
        }
      >
        B
      ...
      <div className="p-4 border rounded mt-5">
        ...
        <BubbleMenu editor={editor!} tippyOptions={{ duration: 100 }}>
          <button
            ...
            className={
              editor?.isActive("bold")
                ? "is-active border rounded bg-black text-white border-black px-1 mx-1"
                : "border-black px-1 border rounded bg-white"
            }
          >
            bold
          </button>
          <button
            ...
            className={
              editor?.isActive("italic")
                ? "is-active border rounded bg-black text-white border-black px-1 mx-1"
                : "border-black px-1 border rounded bg-white mx-1"
            }
          >
            italic
          </button>
          ...
          <button
            ...
            className={
              editor?.isActive("link")
                ? "is-active border rounded bg-black text-white border-black px-1 mx-1"
                : "border-black px-1 mx-1 border rounded bg-white"
            }
          >
            link
          </button>
          <button
            className={
              editor?.isActive("link")
                ? "is-active border rounded bg-blue-700 text-white border-black px-1 mx-1"
                : "border-black px-1 mx-1 border rounded bg-white"
            }
